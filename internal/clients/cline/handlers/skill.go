...
// SkillHandler handles skill asset installation for Cline
// Skills are extracted to .cline/skills/{name}/
...
// Install extracts a skill to .cline/skills/{name}/
...
// Remove removes a skill from .cline/skills/
