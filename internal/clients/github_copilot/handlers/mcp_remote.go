...
// MCPRemoteHandler handles MCP remote asset installation for GitHub Copilot (VS Code)
// MCP remote assets contain only configuration, no server code to extract
